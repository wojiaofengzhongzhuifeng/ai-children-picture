import { Section, HeroSection, FeatureCard } from "./style";
import {
  ArtisticIcon,
  ArtisticTickIcon,
  IntelligentIcon,
      ...
      <div className="flex gap-4 justify-center w-full">
        <HeroSection>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
            {/* 卡片 1：AI 智能生成 */}
            <FeatureCard bgClass="bg-orange-50" borderClass="border-orange-200">
              <IntelligentIcon />
            ...
            {/* 卡片 3：专业编辑器 */}
            <FeatureCard bgClass="bg-purple-50" borderClass="border-purple-200">
              <ProfessionalIcon />
