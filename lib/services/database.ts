...
export type CreateProfileDTO = Omit<Database['public']['Tables']['profiles']['Insert'], 'id' | 'created_at' | 'updated_at'>
export type UpdateProfileDTO = Partial<CreateProfileDTO>

export type CreateImageDTO = Omit<Database['public']['Tables']['images']['Insert'], 'id' | 'created_at' | 'updated_at'>
export type UpdateImageDTO = Partial<CreateImageDTO>

export type CreateGenerationDTO = Omit<Database['public']['Tables']['generations']['Insert'], 'id' | 'created_at'>
export type UpdateGenerationDTO = Partial<CreateGenerationDTO>

export type CreateLikeDTO = Omit<Database['public']['Tables']['likes']['Insert'], 'id' | 'created_at'>
